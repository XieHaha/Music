...
public class IRequest extends BaseRequest {
    ...
    public Tasks getEaseAppKey(final ResponseListener<BaseResponse> listener) {
        return requestBaseResponse(GET, "/huanxin/apiKey", Tasks.GET_EASE_APPKEY, String.class, null, listener);
    }
    ...
    public Tasks getSplash(String client, String deviceSystem, String versionCode,
        ...
        return requestBaseResponseByJson("/DPInternal/resource/splash", Tasks.GET_SPLASH, String.class, merchant,
                                         listener);
    }
    ...
    public Tasks getVerifyCode(String phoneNumber, final ResponseListener<BaseResponse> listener) {
        ...
        return requestBaseResponseByJson("/msg/send", Tasks.GET_VERIFY_CODE, String.class, merchant, listener);
    }
    ...
    public Tasks loginAndRegister(String phoneNumber, String code, String role,
        ...
        return requestBaseResponseByJson("/relog/relog", Tasks.LOGIN_AND_REGISTER, LoginSuccessBean.class, merchant,
                                         listener);
    }
     ...
     * 上传头像
     */
    public Tasks uploadHeadImg(File file, String type, final ResponseListener<BaseResponse> listener) {
    ...
    public Tasks updateBasicInfo(String doctorId, int checked, String name, String portraitUrl,
        ...
        return requestBaseResponseByJson("/doctor/info/updateinfo", Tasks.UPDATE_BASIC_INFO, String.class, merchant,
                                         listener);
    }
     ...
     * 上传职业信息
     */
    public Tasks updateJobInfo(String doctorId, int checked, String department, String doctorDescription,
            String hospital, String title, final ResponseListener<BaseResponse> listener) {
        Map<String, Object> merchant = new HashMap<>(16);
        merchant.put("doctorId", doctorId);
        merchant.put("checked", checked);
        ...
        return requestBaseResponseByJson("/doctor/info/updatedetail", Tasks.UPDATE_JOB_INFO, String.class, merchant,
                                         listener);
    }
    ...
    public Tasks updateUserInfo(String doctorId, int fieldId, com.alibaba.fastjson.JSONObject json,
        ...
        return requestBaseResponseByJson("/doctor/info/update", Tasks.UPDATE_USER_INFO, String.class, merchant,
                                         listener);
    }
    ...
    public Tasks getPatientList(String doctorId, int pageNo, int pageSize,
        ...
        return requestBaseResponseListByJson("/dp/patient", Tasks.GET_PATIENTS_LIST, PatientBean.class, merchant,
                                             listener);
    }
    ...
    public Tasks addPatientByScanOrChangePatient(String doctorId, String fromDoctorId, String patientId,
        ...
        return requestBaseResponseByJson("/dp/trans/focus/doctor", Tasks.ADD_PATIENT_BY_SCAN_OR_CHANGE_PATIENT,
    ...
    public Tasks addPatientByScan(String doctorId, String patientId, int requestSource,
        ...
        merchant.put("patientId", patientId);
        merchant.put("requestSource", requestSource);
        return requestBaseResponseByJson("/dp/scan/focus/patient", Tasks.ADD_PATIENT_BY_SCAN_OR_CHANGE_PATIENT,
                                         PatientBean.class, merchant, listener);
    }
    ...
    public Tasks applyCooperateDoc(String colleborateDoctorId, String doctorId, int requestSource,
        ...
        merchant.put("requestSource", requestSource);
        return requestBaseResponseByJson("/colleborate/applyRequest", Tasks.APPLY_COOPERATE_DOC, PatientBean.class,
                                         merchant, listener);
    }
    ...
    public Tasks modifyNickName(String doctorId, String colleborateDoctorId, String nickname,
        ...
        return requestBaseResponseByJson("/colleborate/nickname", Tasks.MODIFY_NICK_NAME, String.class, merchant,
                                         listener);
    }
     ...
     */
    public Tasks modifyNickNameByPatient(String doctorId, String patientId, String nickname, String from,
            final ResponseListener<BaseResponse> listener) {
        Map<String, Object> merchant = new HashMap<>(16);
        merchant.put("doctorId", doctorId);
        merchant.put("patientId", patientId);
        ...
        return requestBaseResponseByJson("/dp/nickname", Tasks.MODIFY_NICK_NAME_BY_PATIENT, String.class, merchant,
                                         listener);
    }
    ...
    public Tasks cancelCooperateDoc(String doctorId, String doctorId2, final ResponseListener<BaseResponse> listener) {
        ...
        return requestBaseResponse(GET, "/colleborate/delete", Tasks.CANCEL_COOPERATE_DOC, CooperateDocBean.class,
                                   params, listener);
    }
    ...
    public Tasks getApplyPatientList(String doctorId, int pageNo, int pageSize,
        ...
        merchant.put("pageNo", pageNo);
        merchant.put("pageSize", pageSize);
        return requestBaseResponseListByJson("/dp/patient/request", Tasks.GET_APPLY_PATIENT_LIST, PatientBean.class,
                                             merchant, listener);
    }
    ...
    public Tasks getDocInfo(String doctorId, final ResponseListener<BaseResponse> listener) {
        ...
        return requestBaseResponse(GET, "/doctor/info", Tasks.GET_DOC_INFO, CooperateDocBean.class, params, listener);
    }
    ...
    public Tasks refusePatientApply(String doctorId, String patientId, int requestSource,
        ...
        merchant.put("patientId", patientId);
        merchant.put("requestSource", requestSource);
        return requestBaseResponseByJson("/dp/scan/against/patient", Tasks.REFUSE_PATIENT_APPLY, String.class, merchant,
                                         listener);
    }
    ...
    public Tasks agreePatientApply(String doctorId, String patientId, int requestSource,
        ...
        merchant.put("requestSource", requestSource);
        return requestBaseResponseByJson("/dp/scan/agree/V2.0", Tasks.AGREE_PATIENT_APPLY, String.class, merchant,
                                         listener);
    }
    ...
    public Tasks dealDocApply(String appliedId, String applyId, int proCode, int requestSource,
        ...
        merchant.put("requestSource", requestSource);
        return requestBaseResponseByJson("/colleborate/applyProcess", Tasks.DEAL_DOC_APPLY, String.class, merchant,
                                         listener);
    }
    ...
    public Tasks getPatientInfo(String patientId, final ResponseListener<BaseResponse> listener) {
        ...
        return requestBaseResponse(GET, "/patient/info", Tasks.GET_PATIENT_INFO, PatientBean.class, params, listener);
    }
    ...
    public Tasks deletePatient(String doctorId, String patientId, final ResponseListener<BaseResponse> listener) {
        ...
        params.addBodyParameter("doctorId ", doctorId);
        params.addBodyParameter("patientId", patientId);
        return requestBaseResponse(GET, "/dp/cancel/focus", Tasks.DELETE_PATIENT, String.class, params, listener);
    }
    ...
    public Tasks getPatientLimitCaseList(String doctorId, String patientId,
        ...
        merchant.put("doctorId", doctorId);
        merchant.put("patientId", patientId);
        return requestBaseResponseListByJson("/case/doctor/query", Tasks.GET_PATIENT_LIMIT_CASE_LIST,
     ...
     * 好友验证 是否为好友
     */
    public Tasks friendsVerify(String doctorId, String patientId, final ResponseListener<BaseResponse> listener) {
        RequestParams params = new RequestParams();
        params.addBodyParameter("doctorId ", doctorId);
        params.addBodyParameter("patientId", patientId);
        return requestBaseResponse(GET, "/dp/verify", Tasks.FRIENDS_VERIFY, CooperateDocBean.class, params, listener);
    }
    ...
    public Tasks deletePatientCase(String patientId, int fieldId, String caseCreatorId, String caseOperatorId,
        ...
        return requestBaseResponseByJson("/case/delete", Tasks.DELETE_PATIENT_CASE, String.class, merchant, listener);
    }

    /**
     * 医生资质认证
     */
    public Tasks qualifiyDoc(String doctorId, String name, String identityNumber, String title, String department,
            String hospital, File idFront, File idEnd, File qualifiedFront, File qualifiedEnd,
            final ResponseListener<BaseResponse> listener) {
        Map<String, Object> merchant = new HashMap<>();
        merchant.put("doctorId", doctorId);
        merchant.put("name", name);
        ...
        return qualityDoc("/doctor/info/qualifiy", Tasks.QUALIFIY_DOC, files, merchant, String.class, listener);
    }
    ...
    public Tasks getNewVersion(final ResponseListener<BaseResponse> listener) {
        ...
        return requestBaseResponseListByJson("/app/version", Tasks.UPDATE_VERSION, Version.class, merchant, listener);
    }

    /**
     * 获取医院列表
     */
    public Tasks getHospitalList(String doctorId, int productTypeId, final ResponseListener<BaseResponse> listener) {
        Map<String, Object> merchant = new HashMap<>(16);
        merchant.put("doctorId", doctorId);
        merchant.put("productTypeId", productTypeId);
        return requestBaseResponseListByJson("/product/info/doctor/hospital", Tasks.GET_HOSPITAL_LIST,
     ...
     */
    public Tasks getHospitalListByDoctorId(String doctorId, final ResponseListener<BaseResponse> listener) {
        Map<String, Object> merchant = new HashMap<>(16);
        merchant.put("doctorId", doctorId);
        return requestBaseResponseListByJson("/hospital/doctor/relation/list", Tasks.GET_HOSPITAL_LIST_BY_DOCTORID,
                                             HospitalBean.class, merchant, listener);
    }
     ...
     * 获取我的合作医院
     */
    public Tasks getCooperateHospitalListByDoctorId(String doctorId, final ResponseListener<BaseResponse> listener) {
        Map<String, Object> merchant = new HashMap<>(16);
        merchant.put("doctorId", doctorId);
        return requestBaseResponseListByJson("/hospital/doctor/relation/collaborate/hospital/list",
                                             Tasks.GET_COOPERATE_HOSPITAL_LIST_BY_DOCTORID, HospitalBean.class,
                                             merchant, listener);
    }
    ...
    public Tasks getCooperateHospitalDoctorList(String hospitalId, int pageNo, int pageSize,
        ...
        return requestBaseResponseListByJson("/hospital/doctor/relation/internal/doctor/list",
                                             Tasks.GET_COOPERATE_HOSPITAL_DOCTOR_LIST, CooperateHospitalDocBean.class,
                                             merchant, listener);
    }
     ...
     */
    public Tasks getHospitalProductListByHospitalId(String hospitalId, final ResponseListener<BaseResponse> listener) {
        Map<String, Object> merchant = new HashMap<>(16);
        merchant.put("hospitalId", hospitalId);
    ...
    public Tasks getAllProduct(final ResponseListener<BaseResponse> listener) {
        RequestParams params = new RequestParams();
        return requestBaseResponseList(GET, "/product/type/all", Tasks.GET_ALL_PRODUCT, RegistrationTypeBean.class,
                                       params, listener);
    }
    ...
    public Tasks getPatientCombine(String patientId, final ResponseListener<BaseResponse> listener) {
        RequestParams params = new RequestParams();
        params.addBodyParameter("patientId", patientId);
        return requestBaseResponse(GET, "/patient/combine", Tasks.GET_PATIENT_COMBINE, CombineBean.class, params,
                                   listener);
    }
    ...
    public Tasks getTransferPatientHistoryList(String patientId, int pageNo, int pageSize, int days,
        ...
        return requestBaseResponseListByJson("/trans/patient/notes", Tasks.GET_TRANSFER_PATIENT_HISTORY_LIST,
                                             TransPatientBean.class, merchant, listener);
    }
     ...
     * 获取某个患者的转诊单
     */
    public Tasks getTransferByPatient(String doctorId, String patientId, int pageNo, int pageSize, int days,
            final ResponseListener<BaseResponse> listener) {
        Map<String, Object> merchant = new HashMap<>(16);
        merchant.put("doctorId", doctorId);
        merchant.put("patientId", patientId);
        ...
        //传0 代表不限制时间
        merchant.put("days", days);
        return requestBaseResponseListByJson("/trans/doctor/patient/notes", Tasks.GET_TRANSFER_BY_PATIENT,
                                             TransPatientBean.class, merchant, listener);
    }
    ...
    public Tasks getPatientAllOrders(String patientId, int page, int pageSize,
        ...
        return requestBaseResponseListByJson("/order/patient/all/orders", Tasks.GET_PATIENT_ALL_ORDER_LIST,
    ...
    public Tasks getPatientOrders(String doctorId, String patientId, int page, int pageSize,
        ...
        return requestBaseResponseListByJson("/order/doctor/patient/notes", Tasks.GET_PATIENT_ORDER_LIST,
                                             RegistrationBean.class, params, listener);
    }
}
