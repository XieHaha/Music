...
public class WebViewActivity extends AppCompatActivity
{
    ...
    private File fileUri = new File(Environment.getExternalStorageDirectory().getPath() + "/" +
    ...
    public class MyChromeWebClient extends WebChromeClient
    {
        ...
        {
            Log.d(TAG,
                  "openFileChoose(ValueCallback<Uri> uploadMsg, String acceptType, String capture)");
            mUploadMessage = uploadMsg;
            if (videoFlag)
            {
                recordVideo();
        ...
        {
            Log.d(TAG,
                  "onShowFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture)");
    ...
    private void takePhoto()
    {
        ...
        {
            imageUri = FileProvider.getUriForFile(WebViewActivity.this,
                                                  getPackageName() + ".fileprovider",
                                                  fileUri);//通过FileProvider创建一个content类型的Uri
        }
