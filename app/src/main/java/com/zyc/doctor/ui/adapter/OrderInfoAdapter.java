        ...
        public void showView(final int position, final RegistrationBean curTransferPatient) {
            ...
            switch (curTransferPatient.getOrderState()) {
                case STATUS_SUBSCRIBE_NONE:
                    ...
                    tvStatus.setTextColor(ContextCompat.getColor(context, R.color.app_main_txt_color));
                    break;
                ...
                case STATUS_REFUSE:
                    ...
                    tvStatus.setTextColor(ContextCompat.getColor(context, R.color.app_red_color));
                    break;
                default:
                    break;
            }
