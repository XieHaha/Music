...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs) {
        ...
        progressColorBackground = a.getColor(R.styleable.CircleProgressBar_progressColorBackground, Color.WHITE);
        progressColor = a.getColor(R.styleable.CircleProgressBar_progressColor, Color.rgb(0x57, 0x87, 0xb6));
