...
//        if (Global.getInstance().launchMode == Mode.Launch.RELEASE && Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
...
//                .resetViewBeforeLoading(true)
    ...
    public DisplayImageOptions getOptionsForPortrait() {
        return new DisplayImageOptions.Builder()
                ...
                .cacheOnDisk(true)
//                .bitmapConfig(Bitmap.Config.RGB_565)
                .showImageForEmptyUri(R.mipmap.ic_default_blue)
                .showImageOnFail(R.mipmap.ic_default_blue)
                .showImageOnLoading(R.mipmap.ic_default_blue)
