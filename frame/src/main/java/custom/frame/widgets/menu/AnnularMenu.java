        ...
        for (int i = 0; i < count - 1; i++)
        {
            ...
            if (mCurrentStatus == Status.CLOSE)
            {
                ...
                tranAnim = new TranslateAnimation(
                        xflag * (childLeft - child.getMeasuredWidth() / 2), 0,
                        yflag * (childTop - child.getMeasuredWidth() / 2), 0);
            ...
            {        //to close
                ...
                tranAnim = new TranslateAnimation(0, xflag *
                                                     (childLeft - child.getMeasuredWidth() / 2), 0,
                                                  yflag *
                                                  (childTop - child.getMeasuredWidth() / 2));
