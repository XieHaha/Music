 ...
 */
public class CustomRelStatusBar extends RelativeLayout {
    ...
    public CustomRelStatusBar(Context context) {
        this(context, null);
        this.context = context;
    }

    public CustomRelStatusBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        this.context = context;
    }

    public CustomRelStatusBar(Context context, AttributeSet attrs, int defStyleAttr) {
