package custom.frame.widgets.textview;
...
public class ExspandTextView extends AppCompatTextView
{
    ...
    private static final int TO_EXPAND_HINT_COLOR = 0xFFF95790;
    private static final int TO_SHRINK_HINT_COLOR = 0xFFF95790;
    ...
    private CharSequence getNewTextByConfig()
    {
        ...
        switch (mCurrState)
        {
            case STATE_SHRINK:
            {
                ...
                SpannableStringBuilder ssbShrink = new SpannableStringBuilder(fixText).append(
                        mEllipsisHint);
