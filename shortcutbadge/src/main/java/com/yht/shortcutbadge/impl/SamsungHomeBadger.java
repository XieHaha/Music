package com.yht.shortcutbadge.impl;
...
import com.yht.shortcutbadge.Badger;
import com.yht.shortcutbadge.ShortcutBadgeException;
import com.yht.shortcutbadge.util.CloseHelper;
            ...
            try {
                ...
                if (cursor != null) {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        contentResolver.update(mUri, contentValues, "_id=?", new String[]{
                                String.valueOf(id)});
